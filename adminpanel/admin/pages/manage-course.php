                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            ...
                            <tbody>
                              <?php 
                                $selCourse = $conn->query("SELECT * FROM branch_tbl ORDER BY branch_name  ");
                                    ...
                                    while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a rel="facebox" style="text-decoration: none;" class="btn btn-primary btn-sm" href="facebox_modal/updateCourse.php?id=<?php echo $selCourseRow['branch_id']; ?>" id="updateCourse">Update</a>
