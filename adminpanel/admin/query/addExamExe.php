<?php 
 ...
 $selCourse = $conn->query("SELECT * FROM exam_tbl WHERE ex_subject='$examTitle' ");
 ...
 else
 {
	...
	$insExam = $conn->query("INSERT INTO exam_tbl(branch_id,ex_subject,ex_time_limit,ex_questlimit_display,ex_description) VALUES('$courseSelected','$examTitle','$timeLimit','$examQuestDipLimit','$examDesc') ");
	if($insExam)
	{
