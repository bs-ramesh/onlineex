...
<div class="box-form">
	<div class="left">
		...
		<p style="opacity: 0;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
    ...
    padding-left: 40px;">
		...
		<!-- <h5>JSSTU</h5> -->
		<img src="d1.png" alt="JSSTU" width="250 px" style="margin: 70 px ;">
<!-- <p style="opacity: 0 ; height: 250 px;"> dijadjad9adjadajidjajdinabdiwjbadj</p> -->
<form method="post" id="adminLoginFrm" class="validate-form" style=" width: 100%;
    display: -webkit-box;
    display: -webkit-flex;
    display: -moz-box;
    display: -ms-flexbox;
...
<div class="inputs">
			...
			<br><br>
			<button type="submit" class="login100-form-btn" style="margin: 20px auto; border-radius:20px;">
				Login
			</button>
</form>
		</div>
