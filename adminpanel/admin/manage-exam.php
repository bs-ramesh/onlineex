...
<?php 
   ...
   $selCourse = $conn->query("SELECT branch_name as courseName FROM branch_tbl WHERE branch_id='$courseId' ")->fetch(PDO::FETCH_ASSOC);
 ?>
                     ...
                     <div class="page-title-heading">
                        <div> MANAGE EXAM
                            <div class="page-title-subheading">
                              Add Question for <?php echo $selExamRow['ex_subject']; ?>
                            </div>
                        </div>
                    </div>
                </div>
                           ...
                           <form method="post" id="updateExamFrm">
                               <div class="form-group">
                                ...
                                <select class="form-control" name="courseId" required="">
                                  <option value="<?php echo $selExamRow['branch_id']; ?>"><?php echo $selCourse['courseName']; ?></option>
                                  <?php 
                                    $selAllCourse = $conn->query("SELECT * FROM branch_tbl ORDER BY branch_id DESC");
                                    while ($selAllCourseRow = $selAllCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                                      <option value="<?php echo $selAllCourseRow['branch_id']; ?>"><?php echo $selAllCourseRow['branch_name']; ?></option>
                                    <?php }
                                   ?>
                                </select>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="" name="examTitle" class="form-control" required="" value="<?php echo $selExamRow['ex_subject']; ?>">
                              </div>  
